...
{check?(<div id="icrvgp" className="cell gpd-clm"  >
                                                        <div id="i6vd27" className="gdp-row gpd-grid"  >
                                                            ...
                                                            <div id="iytw4t" className="cell gpd-clm" >
                                                                <a id="i9imej" className="gpd-text" href="#reactimages" data-toggle="collapse" data-parent="#MainMenu">reactimages <i className="fa fa-caret-down"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>):<></>}
                                                    {check?( <div className="collapse" id="reactimages">
                                                        <div id="icrvgp" className="cell gpd-clm">
                                                            <div id="i6vd27" className="gdp-row gpd-grid">
                                                                <div id="iytw4t" className="cell gpd-clm">
<a id="i9imej" className="gpd-text" href='/signupscreen'>signupscreen</a>
                                        
<a id="i9imej" className="gpd-text" href='/dashboardscreen'>dashboardscreen</a>
                                        
<a id="i9imej" className="gpd-text" href='/reportscreen'>reportscreen</a>
                                        
<a id="i9imej" className="gpd-text" href='/updatescreenaccount'>updatescreenaccount</a>
                                        
<a id="i9imej" className="gpd-text" href='/crentryscreen'>crentryscreen</a>
                                        
<a id="i9imej" className="gpd-text" href='/generallegscreen'>generallegscreen</a>
