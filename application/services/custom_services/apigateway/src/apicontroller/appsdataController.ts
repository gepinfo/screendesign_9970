...
export class appsdataController implements Controller {
    ...
    private initializeRoutes() {
        this.router.post('/appsdata', this.GpCreate);
this.router.get('/appsdata/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
    }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.REACTIMAGESURL + `${req.url}` , req.body)
...
public GpGetNounCreatedBy(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.REACTIMAGESURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
